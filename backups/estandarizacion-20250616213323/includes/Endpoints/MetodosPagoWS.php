...
/**
 * Clase para gestionar el endpoint de metodospagos
 */
class MetodosPagoWS extends Base {
	use EndpointLogger;

	public const ENDPOINT_NAME        = 'GetMetodosPagoWS';
	public const CACHE_KEY_PREFIX     = 'mi_api_metodos_pago_';
