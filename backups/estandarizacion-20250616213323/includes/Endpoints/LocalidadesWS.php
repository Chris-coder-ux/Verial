...
/**
 * Clase para gestionar el endpoint de localidades
 */
class LocalidadesWS extends Base {
	use EndpointLogger;

	public const ENDPOINT_NAME        = 'GetLocalidadesWS';
	public const CACHE_KEY_PREFIX     = 'mi_api_localidades_';
