...
/**
 * Clase para gestionar el endpoint de asignaturas
 */
class AsignaturasWS extends Base {
	use EndpointLogger;

	public const ENDPOINT_NAME        = 'GetAsignaturasWS';
	public const CACHE_KEY_PREFIX     = 'mi_api_asignaturas_';
