...
/**
 * Clase para gestionar el endpoint de categoriaswebs
 */
class CategoriasWebWS extends Base {
	use EndpointLogger;

	public const ENDPOINT_NAME               = 'GetCategoriasWebWS';
	public const CACHE_KEY_PREFIX            = 'mi_api_categorias_web_';
	public const CACHE_EXPIRATION            = 12 * HOUR_IN_SECONDS; // 12 horas
	public const MAX_LENGTH_NOMBRE_CATEGORIA = 255;
	...
	/**
	 * Registra la ruta REST para el endpoint de Categorías Web.
	 */
