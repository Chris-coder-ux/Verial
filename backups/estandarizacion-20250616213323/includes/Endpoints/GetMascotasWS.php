...
class GetMascotasWS extends \MiIntegracionApi\Endpoints\Base {
	...
	const CACHE_KEY_PREFIX     = 'mi_api_mascotas_';
	 ...
	 */
	private function validate_id_cliente($id_cliente): bool|\WP_Error {
		if (!is_numeric($id_cliente) || intval($id_cliente) <= 0) {
			return new \WP_Error(
				'rest_invalid_param',
				esc_html__('El parámetro id_cliente_verial debe ser un número positivo.', 'mi-integracion-api'),
				['status' => 400]
			);
		}
