...
/**
 * Clase para gestionar el endpoint de conteo de artículos
 */
class NumArticulosWS extends Base {
...
public function register_route(): void {
	...
	public function validate_time_format_optional( string $value, \WP_REST_Request $request, string $key ): bool|\WP_Error {
		...
		return new WP_Error( 'rest_invalid_param', sprintf( esc_html__( '%s debe ser una hora válida en formato HH:MM o HH:MM:SS.', 'mi-integracion-api' ), $key ), array( 'status' => 400 ) );
	}
