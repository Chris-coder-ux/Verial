...
/**
 * Clase para gestionar el endpoint de agentes
 */
class AgentesWS extends Base {
	use EndpointLogger, CacheableTrait, ErrorHandlerTrait {
		EndpointLogger::log_error insteadof ErrorHandlerTrait;
		ErrorHandlerTrait::log_error as log_error_admin;
	}

	public const ENDPOINT_NAME        = 'GetAgentesWS';
	public const CACHE_KEY_PREFIX     = 'mi_api_agentes_';
